...
public class Lab4TestSolution extends BaseCEPTestCase {

	@Before
	public void setUp() {
		
		setDrls("rules/lab4solution.drl");
    ...
    @Test
    public void testSuspiciousTransactionOver100IsDenied(){
        ...
        Transaction t1 = new Transaction(fromAccount, new BigDecimal("100"));
        Transaction t2 = new Transaction(fromAccount, new BigDecimal("100"));
        Transaction t3 = new Transaction(fromAccount, new BigDecimal("100"));
        Transaction t4 = new Transaction(fromAccount, new BigDecimal("100"));
        Transaction t5 = new Transaction(fromAccount, new BigDecimal("200"));
